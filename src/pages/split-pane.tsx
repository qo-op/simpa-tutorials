...
const SplitPanePage = ({ path }: PageProps) => {
  return (
    ...
    >
      ...
      <p>
        <code>SplitPane</code> is a component that provides a menu bar
      ...
      <p>Here's an example of SplitPane with two drop-down menus:</p>
...
...`}
      ...
      >
        <div className="PageStart">
          <ul className="SplitPane" style={{ backgroundColor: "LightGray" }}>
            <li>
              <div className="Menu">
                <span>File</span>
              </div>
